...
#ifdef MULT
const char *			CL_FILE_NAME = { "firstMult.cl" };
#endif

#ifdef MULT_ADD
const char *			CL_FILE_NAME = { "firstMultAdd.cl" };
#endif
...
#ifdef MULT
	// Do not use this when doing MULT_ADD, this is only for doing MULT
...
// original
	...
	//fprintf(stderr, "NUM_ELEMENTS\tLOCAL_SIZE\tNUM_WORK_GROUPS\t\tPerformance\n");
