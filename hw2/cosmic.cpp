...

{
         ...
         double mbods = (double)(NUMBODIES*NUMBODIES*NUMSTEPS)/(time1-time0)/1000000.;
         ...
         //double mbods = (double)(NUMBODIES*NUMBODIES*NUMSTEPS)/(time1-time0)/1000000.;
 		 double avg = sumMegaBods/(double)NUMTRIES;
         printf("Threads: %d\n", NUMTHREADS);
         //printf("Performance: %10.2lf MBODS\n", mbods); 
         printf("Average Performance: %10.2lf MBODS\n", avg); 
